...
export type MoviesQuery = { __typename?: 'Query', movies?: Array<{ __typename?: 'Movie', title: string, year: number, country: Array<{ __typename?: 'Country', name: string }>, category: Array<{ __typename?: 'Category', name: string }> }> | null };
